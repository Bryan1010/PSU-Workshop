...
// Note I said THIS router. In app.js, we pass this router to any route that start with /api/holidays, so any routes defined here
// will come AFTER that route. '/' in this case corresponds to '/api/holidays/'
router.get('/', holidays.getAll);


// We are exporting the router so that in our app.js, when this file is imported(require), the router will be returned
